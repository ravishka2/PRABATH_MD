...
cmd({
    ...
    async(Void, citel) => {
        ...
        let cap = `*🌐 𝐒𝐚𝐘𝐮 -𝗠𝗗 _𝗢𝗙𝗙𝗜𝗖𝗜𝗔𝗟 ♦️*

●. *Support group :* https://chat.whatsapp.com/KPiKOqO8XXJ3VHgoFfQcKH

●. *Youtube:* https://youtube.com/@adzonemusic

●. *Developer:* https://github.com/ravishka2

sᴀʏᴜ ᴍᴅ ⦁ ᴍᴀᴅᴇ ʙʏ ʀᴀᴠɪsʜᴋᴀ
ʀᴇʟᴇᴀsᴇᴅ ⦁ 𝟸𝟶𝟸𝟹/𝟶5/21
`
        let buttonMessaged = {
...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            let buttons = [{
                    ...
                    buttonId: `${prefix}promote 94773721711`,
